...
Pada Desember 2024, React 19 dirilis sebagai versi stabil dengan compiler sebagai komponen opsional. Selain compiler, React 19 membawa fitur-fitur lain: Actions untuk menangani async mutations, `useOptimistic` untuk optimistic updates, dan stabilisasi Server Components. Versi terbaru saat artikel ini ditulis adalah 19.2.7, dirilis 1 Juni 2026 (Wikipedia, "React (software)").

Ada juga perubahan tata kelola yang signifikan. Pada Oktober 2025, Meta mengumumkan akan mendonasikan React, React Native, dan JSX ke sebuah yayasan baru di bawah Linux Foundation. Yayasan React resmi diluncurkan pada 24 Februari 2026. Ini berarti React tidak lagi dimiliki oleh satu perusahaan — sebuah langkah penting untuk keberlanjutan ekosistem yang digunakan oleh jutaan developer.
...
Bagi tim engineering, saya menyarankan pendekatan tiga fase: pertama, jalankan ESLint dengan Rules of React di seluruh codebase dan perbaiki warning. Kedua, aktifkan compiler di modul yang paling bersih dan ukur peningkatannya. Ketiga, perluas secara bertahap sambil memantau production error logs. Jangan terburu-buru — tapi jangan juga menunda selamanya. React telah berubah, dan kita perlu berubah bersamanya.
